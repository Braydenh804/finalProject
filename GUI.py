...
search_button = Button(movie_search_page, text="Search", bg="#0c2b59", fg="#FFFFFF", font=("Arial", 16), command=lambda: search_movie_file(search_entry.get()))
...
tv_search_button = Button(tv_search_page, text="Search", bg="#0c2b59", fg="#FFFFFF", font=("Arial", 16), command=lambda: search_result_page.show())
